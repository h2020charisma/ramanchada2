...
class TwinningComponent(Plottable):
    ...
    def __init__(self, twinned : SpectraFrame , reference : SpectraFrame,boundaries=None,reference_band_nm=144.0,
    ...
    def calc_peak_intensity(self,spe : Spectrum,boundaries=None,prominence_coeff=0.01,no_fit=False,peak_intensity="height"):
        try:
            ...
            df["sorted"] = abs(df["center"] - self.reference_band_nm) #closest peak to 144
    ...
    def laser_power_regression(self, df : SpectraFrame,boundaries=None,no_fit=False,source='spectrum'):
        ...
        for index, row in df.iterrows():
            ...
            if boundaries is None:
                boundaries=(self.reference_band_nm-50, self.reference_band_nm+50)
            peak_intensity, peak_position,fit_res = self.calc_peak_intensity(spe,boundaries=boundaries,no_fit=no_fit)
